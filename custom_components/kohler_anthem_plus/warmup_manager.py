...
either: it is in :mod:`.anthem_plus.warmup`, with no I/O and no Home Assistant, so it can
...
from .anthem_plus.warmup import journal_event, restore_target, should_restore_warmup
from .const import (
