...
adopted after session 9 (`docs/handoff/2026-08-17_session9.md`, local only) §1, where a GCS limit of
...
Session 9 (`docs/handoff/2026-08-17_session9.md`, local only) §1 left this explicitly open — three
