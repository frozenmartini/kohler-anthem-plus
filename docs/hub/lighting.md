...
even though the 2026-08-10 local-probing notes (a private handoff, since folded into
[`local_api.md`](local_api.md)) recorded it as enabled on 2026-08-10. Something turned it back off in between — plausibly
