...
<p>In the automation editor, search for <b>Kohler Anthem Plus: Custom shower</b>. Or, in YAML
and in <b>Developer tools → Actions</b>, the service action
<code>kohler_anthem_plus.custom_shower</code>.</p>
